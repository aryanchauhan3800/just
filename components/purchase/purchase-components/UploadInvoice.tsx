...
import UploadInvoiceUpdateModal from './UploadInvoiceUpdateModal'

const UploadInvoice = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    ...
    return (
        <>
                ...
                <DialogContent className='[&>button]:hidden p-0 rounded-none min-w-2xl'>
                    ...
                    <div className='px-6'>
                        <div className='flex flex-col space-y-2'>
                            ...
                            <p className='text-base text-[#474747]'>Upload the invoice received from Vendor to track outgoing payments</p>
                            <label
            ...
            <UploadInvoiceUpdateModal open={isFileModalOpen} onOpenChange={setFileModalOpen} file={selectedFile} />
        </>
    )
}
