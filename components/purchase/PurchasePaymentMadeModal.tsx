...
const PurchasePaymentMadeModal = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    return (
                ...
                <div className='px-6'>
                    ...
                    <div className='border rounded-xl flex flex-row w-full mb-4'>
                        <div className='px-4 py-3 w-1/2'>
                            <p className='text-[#242424] text-sm'>To pay <span className='text-[#8F8F8F] text-xs'>for this purchase</span></p>
...
export default PurchasePaymentMadeModal