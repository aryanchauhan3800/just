...
const RecordDebitPayment = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className='[&>button]:hidden p-0 min-w-6xl'>
                ...
                <div className='grid grid-cols-[1.5fr_2fr] gap-8 w-full pb-20 overflow-auto'>
                    <div className='pl-8'>
                        <div className='flex justify-center items-center h-2/3 bg-gradient-to-b from-[#F7E2E4] to-[#FFFFFF]'>
                            <Image src="/recorddebit.png" alt='recorddebit' height={120} width={120} />
                        </div>
                        <div className='bg-[#FAFAFA] p-4'>
                            <div className='space-y-2'>
                                ...
                                <p className='text-sm text-[#6B6B6B]'># PO 000010 - Purchase Date : 24 Apr, 2025</p>
                            </div>
                            <hr className='my-2' />
                            <div className='flex flex-row gap-20'>
                                <div className='flex flex-col'>
                                    <span className='text-sm text-[#6B6B6B]'>Purchase Amount:</span>
                                    <span>40,00,000</span>
                                </div>
                                <div className='flex flex-col'>
                                    <span className='text-sm text-[#6B6B6B]'>To Recieve:</span>
                                    <span>80,000</span>
                                </div>
                            </div>
                        </div>
...
export default RecordDebitPayment