...
type UploadDebitNoteUpdateProps = {
    open: boolean;
    onOpenChange: (open: boolean) => void;
    file: File | null;
}

const UploadDebitNoteUpdate = ({ open, onOpenChange, file }: UploadDebitNoteUpdateProps) => {
    const { setIsDebitNoteUploaded } = useDebitNoteUploaded()
...
export default UploadDebitNoteUpdate