...
import PRPaymentTabs from './PRPaymentTabs';
import PRPaymentMade from './PRPaymentMade';

const PRPaymentModal = ({ open, onOpenChange }: InvoiceDrawerProps) => {
