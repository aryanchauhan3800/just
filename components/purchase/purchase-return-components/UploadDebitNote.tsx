...
import UploadDebitNoteUpdate from './UploadDebitNoteUpdate'

const UploadDebitNote = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    ...
    return (
        <>
            ...
            <UploadDebitNoteUpdate open={isFileModalOpen} onOpenChange={setFileModalOpen} file={selectedFile} />
        </>
    )
}

export default UploadDebitNote