...
const getMenuOptionsByStatus = (status: string): MenuOption[] => {
    switch (status) {
        ...
        case 'Partially Adjusted':
            return [
                { label: 'View Credit Note', icon: IoMdEye, action: 'view', color: "text-[#474747]" },
                { label: 'Adjust Now', icon: HiOutlineBanknotes, action: 'adjustNow', color: "text-[#474747]" },
                { label: 'Delete Credit Note now', icon: RxTrash, action: 'delete', color: "text-[#F5222D]" },
            ];
        case 'Fully Adjusted':
            return [
                { label: 'View Credit Note', icon: IoMdEye, action: 'view', color: "text-[#474747]" },
                { label: 'Delete Sales Order', icon: RxTrash, action: 'delete', color: "text-[#F5222D]" },
            ];
    }
};
...
const credits = [
    {
        creditNote: "CN-000100",
        createdOn: "12-Jan-2025",
        customerName: "Ashok Srivastav",
        avatarColor: "#FF5A5F",
        avatarInitial: "A",
        amount: "80,000",
        action: "pay",
    ...
    {
        creditNote: "CN-000101",
        createdOn: "15-Jan-2025",
        customerName: "Akansha Mehra",
        avatarColor: "#00D2FF",
        avatarInitial: "A",
        amount: "1,20,000",
        action: "receive",
    ...
    {
        creditNote: "CN-000102",
        createdOn: "18-Jan-2025",
        customerName: "Prabir Joshi",
        avatarColor: "#32CD32",
        avatarInitial: "P",
        amount: "95,000",
        action: "pay",
    ...
    {
        creditNote: "CN-000103",
        createdOn: "20-Jan-2025",
        customerName: "Balwant Singh Joshi",
        avatarColor: "#FFD700",
        avatarInitial: "B",
        amount: "75,000",
        action: "receive",
...
export default function CreditTable() {
    ...
    const filteredRows = credits.filter((order) => {
        const matchName = order.customerName.toLowerCase().includes(searchText.toLowerCase());
