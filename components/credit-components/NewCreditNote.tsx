...
import ReasonForCredit from './ReasonForCredit';
...
const NewCreditNote = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    const [selectedInvoice, setSelectedInvoice] = useState<string | null>(null);
    const [showReasonCredit, setShowCreditReason] = useState(false)
            ...
            <Dialog open={open} onOpenChange={onOpenChange}>
                ...
                >
                    ...
                    <div className='py-2 space-y-4'>
                        <p className='text-base text-[#474747] px-4'>Select a Customer from Sales Invoices</p>
                        <div className='px-6'>
                            <Input
                                    ...
                                    <Table sx={{ minWidth: '100%' }}>
                                        <TableHead>
                                            <TableRow sx={{ borderBottom: '1px solid #E5E7EB' }}>
                                                ...
                                                <TableCell sx={{ py: 2, px: 0, fontSize: '0.875rem', fontWeight: 500, color: '#4B5563' }}>
                                                    <span className="border-l-2 px-3">Invoice Amt</span>
                                                </TableCell>
                                                <TableCell sx={{ py: 2, px: 0, fontSize: '0.875rem', fontWeight: 500, color: '#4B5563' }}>
                                                    <span className="border-l-2 px-3">Payment Status</span>
                                                </TableCell>
                                            </TableRow>
                                        </TableHead>
                    ...
                    <DialogFooter className="w-full flex justify-between border-t px-6 py-2">
                        ...
                        >
                            Create Create Note <ChevronRight />
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
            <ReasonForCredit open={showReasonCredit} onOpenChange={setShowCreditReason} />
        </>
    )
}
