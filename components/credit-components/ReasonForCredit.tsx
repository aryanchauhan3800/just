...
const ReasonForCredit = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    const [showItemsReturned, setShowItemsReturned] = useState(false)
...
export default ReasonForCredit