...
import PRPaymentMade from '../purchase/purchase-return-components/PRPaymentMade';
import PRPaymentTabs from '../purchase/purchase-return-components/PRPaymentTabs';

const DebitPaymentModal = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    ...
    return (
        <>
                    ...
                    <DialogHeader className="flex-shrink-0">
                        <div className='flex flex-row justify-between items-center border-b py-4 px-6'>
                            <DialogTitle className='text-lg text-[#474747] flex items-center gap-2'>
                                <RiFileList3Line />Debit Note Settlement
                            </DialogTitle>
                            <DialogClose asChild>
                            ...
                            <div className="w-full overflow-hidden">
                                ...
                                >
                                    <div className="snap-start min-w-full flex-shrink-0">
                                        <p className='text-[#6B6B6B] text-lg mb-2'>Debit Note Settlement</p>
            ...
            <PRPaymentMade open={showMadePaymentModal} onOpenChange={setShowMadePaymentModal} />
        </>
    )
}
