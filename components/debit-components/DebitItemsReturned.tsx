...
import ReasonForDebit from './ReasonForDebit';

const DebitItemsReturned = ({ open, onOpenChange }: InvoiceDrawerProps) => {
    const [showDebitReasonModal, setShowDebitReasonModal] = useState(false)

    const handleConfirmReturnNext = () => {
        onOpenChange(false)
        setShowDebitReasonModal(true)
    }
    ...
    const columns = [
        ...
        {
            field: 'price',
            headerName: 'Purchase Price / Unit',
            width: 200,
            renderCell: () => (
        ...
        },
        {
            ...
            renderCell: () => (
                <Select>
                    ...
                    <SelectContent>
                        <SelectItem value="essential_food">
                            <div className='flex flex-col'>
                                <p>Essential Food Items - 0%</p>
                                <p>Milk, bread, wheat</p>
                            </div>
                        </SelectItem>
                        <SelectItem value="packaged_food">
                            <div className='flex flex-col'>
                                <p>Packaged Food - 5%</p>
                                <p>Branded Rice, Biscuits, etc.</p>
                            </div>
                        </SelectItem>
                        <SelectItem value="medicines">
                            <div className='flex flex-col'>
                                <p>Pharamceuticals - 5%</p>
                                <p>Medicine & Supplies</p>
                            </div>
                        </SelectItem>
                        ...
                        <SelectItem value="luxury">
                            <div className='flex flex-col'>
                                <p>Luxury Items - 28%</p>
                                <p>ACs, Refrigerators</p>
                            </div>
                        </SelectItem>
                        <SelectItem value='restaurant'>Restaurant Food (non-AC) - 5%</SelectItem>
                        <SelectItem value='phone'>Mobile Phones - 12%</SelectItem>
                        <SelectItem value='textile'>Textile (below ₹1000 per piece) - 12%</SelectItem>
                    </SelectContent>
                </Select>
            )
        },
    ...
    return (
        <>
            ...
            <ReasonForDebit open={showDebitReasonModal} onOpenChange={setShowDebitReasonModal} />
        </>
    )
}

export default DebitItemsReturned