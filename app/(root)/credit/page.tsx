...
import CreditTable from '@/components/credit-components/CreditTable';
import NewCreditNote from '@/components/credit-components/NewCreditNote';
...
const items: StripItem[] = [
    ...
    {
        title: "Received in last 30 days",
...
const page = () => {
    ...
    return (
        <>
            ...
            <NewCreditNote open={showPurchaseOrder} onOpenChange={setShowPurchaseOrder} />
        </>
    )
}
